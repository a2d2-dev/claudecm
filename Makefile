...
LDFLAGS=-ldflags "-X github.com/imneov/claudecm/cmd.Version=$(VERSION) -X github.com/imneov/claudecm/cmd.Commit=$(COMMIT) -X github.com/imneov/claudecm/cmd.Date=$(BUILD_DATE)"
